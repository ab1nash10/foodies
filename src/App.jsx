...
function App() {
  ...
  /**
   * This `Header` component in JavaScript React renders a header section with a logo, navigation items,
   * a cart icon, a tagline, and a search bar.
   */
  ...
  // const ResContainer = ({ resName, resRating, cuisineName }) => (

  /**
   * The ResContainer function displays restaurant information including name, rating, image, cuisines,
   * cost for two, locality, and delivery time.
   * @returns The `ResContainer` component is returning a JSX structure that represents a restaurant
   * card. The card includes information such as the restaurant name, average rating, cuisine types, cost
   * for two, locality, and delivery time. The data for these details is being extracted from the
   * `resData` prop passed to the component. The card also displays an image of the restaurant fetched
   * from a Cloudinary URL based on
   */
    ...
    return (
      <div className="res-card leading-relaxed px-4 py-5 font-jost">
        <div className="res-img">
          <img
            src={
              "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_410,h_288,c_fill/" +
              cloudinaryImageId
            }
  ...
  /**
   * The Body component renders multiple instances of the ResContainer component with data from the
   * resList array in a grid layout.
   */
